...
XTTS_LANGS = ["en", "es", "fr", "de", "it", "pt", "pl", "tr", "ru", "nl", "cs", "ar", "zh-cn", "hu", "ko", "ja"]
...
class XTTSClient:
    ...
    def synthesize(self, text, ref_audio, output_path, language="en"):
        ...
        if language == "pl": xtts_lang = "pl"
        elif language == "en": xtts_lang = "en"
        elif language == "ko": xtts_lang = "ko"
        elif language == "ja": xtts_lang = "ja"
        elif language in XTTS_LANGS: xtts_lang = language
        else: xtts_lang = "en"
